...
namespace WebApplication4.Controllers
{
    public class RecordsController : Controller
    {
        ...
        public ActionResult Index()
        {
            ...
            var query = from p in db.Records
                        where p.curuser == User.Identity.Name
                        select p;
            IEnumerable<Record> rec = query.ToList();
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID,fname,lname,email,mobilephone,birthdate,address,description,curuser")] Record record)
        {
            if (ModelState.IsValid)
            {
